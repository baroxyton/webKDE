...
function toMime(filename) {
    ...
    // Split by dot and get last item
    ...
    // Default for no/unknown extension

    return "application/octet-stream"
};
export { toMime as default };